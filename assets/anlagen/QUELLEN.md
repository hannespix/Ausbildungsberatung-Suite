# Anlagen — Formular-PDFs zum Mitschicken

Hier liegen die zum Versand gebündelten Formulare/Vordrucke. Sie werden in den
**Vorlagen** je Schreiben als Anhang ausgewählt und über „E-Mail-Entwurf (.eml)
herunterladen" eingebettet (öffnet in Outlook mit angehängten Dateien) bzw. einzeln
heruntergeladen.

> **Fachverantwortung:** Aktualität und Richtigkeit der Formulare prüft die
> Dienststelle. Quelle und Stand sind je Datei unten dokumentiert und werden im
> Tool angezeigt. Veraltete Stände bitte ersetzen und Eintrag in `assets/js/app.js`
> (`ANLAGEN`) anpassen.
...
Berufsspezifische Anlagen (Gärtner/-in u. a.) sowie RP-interne Vordrucke werden
von der Dienststelle bereitgestellt.
